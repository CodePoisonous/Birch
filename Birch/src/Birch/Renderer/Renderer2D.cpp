...
namespace Birch {
	...
	void Renderer2D::Init()
	{
		...
		s_Data->QuadVertexArray = VertexArray::Creat();
	...
	{
		s_Data->TextureShader->SetFloat4("u_Color", color);	// 纯色纹理
	...
	{
		s_Data->TextureShader->SetFloat4("u_Color", glm::vec4(0.5f, 0.7f, 0.6f, 1.0f));	// 图片纹理的底色
		texture->Bind();
