...
namespace Birch {
	...
	{
		Ref<Birch::VertexArray> QuadVertexArray;
		Ref<Birch::Shader> FlatColorShader;
	};
	...
	void Renderer2D::Init()
	{
		...
		s_Data->QuadVertexArray = Birch::VertexArray::Creat();
		...
		s_Data->FlatColorShader = Birch::Shader::Create("assets/shaders/FlatColor.glsl");
	}
